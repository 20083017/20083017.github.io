...
subtitle:   增量格式化、VS Code 接入与多份配置 demo
date:       2026-04-25
author:     BY
...
> 这篇把原始笔记中的脚本、VS Code 接入步骤和多份 `.clang-format` 配置 demo 都整理在一起。多份配置（自用 / 详解版 / jemalloc / Microsoft / Google）都保留，方便对比与切换。
